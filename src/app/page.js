  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 px-6 py-14">
      <div className="max-w-3xl mx-auto border border-gray-300 rounded-2xl p-2  ">
        <h1 className="text-5xl font-extrabold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent text-center mb-3">
          Available Quizzes
        </h1>
          ...
          {QUIZZES.map((quiz) => (
            ...
            >
              ...
              <Link href={`/quiz/${quiz.slug}`}>
                <button
                  className="w-full px-6 py-3 rounded-xl bg-slate-900 text-white font-semibold cursor-pointer
